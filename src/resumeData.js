let resumeData = {
  ...
  socialLinks: [
    {
      name: "André Felipe",
      url: "https://www.linkedin.com/in/andr%C3%A9-felipe-95468b191/",
      className: "fa fa-linkedin",
    },
    {
      name: "André Felipe",
      url: "https://github.com/adr810",
  ...
  work: [
    ...
    {
      CompanyName: "Fundação CESP",
      specialization: "Jovem Aprendiz",
      MonthOfJoining: "Jan",
      YearOfJoining: "2015",
      MonthOfLeaving: "Feb",
      YearOfLeaving: "2016",
      Achievements:
        "Jovem aprendiz, realizando atividades administrativas e operacionais",
    },
  ],
  skillsDescription: "",
  skills: [
